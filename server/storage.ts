...
export class MemStorage implements IStorage {
  ...
  private seedLeads() {
    const seed: Lead[] = [
      ...
      // ── RUTHERFORD COUNTY PROSPECTING LEADS ──────────────────────────────

      // TIER 1: Industrial / Manufacturing (highest job value)
      {
        id: "lead-013", leadId: "GDS-L-0013",
        date: new Date("2026-05-26"), source: "referral",
        name: "Facilities Manager", phone: "", email: null, address: "Nissan Smyrna Plant, 983 Nissan Dr, Smyrna TN 37167", zip: "37167",
        serviceInterest: "construction_cleanup", estimatedValue: "15000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-28"),
        notes: "Topre America referral path. Nissan campus = 5,700 employees, massive facility. Approach via Topre's Ed (superintendent) for intro. Start with parking lot/exterior washing, upsell to equipment.",
        referredBy: "Topre America (lead-011)", adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-014", leadId: "GDS-L-0014",
        date: new Date("2026-05-26"), source: "direct",
        name: "Plant Manager", phone: "", email: null, address: "Bridgestone Americas, La Vergne TN 37086", zip: "37086",
        serviceInterest: "heavy_equipment", estimatedValue: "8000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-29"),
        notes: "Tire manufacturing plant — 1,000+ employees. Equipment is constantly covered in rubber/grease. Massive parking lot + loading docks. Call general line, ask for facilities or maintenance dept.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-015", leadId: "GDS-L-0015",
        date: new Date("2026-05-26"), source: "direct",
        name: "Facilities Contact", phone: "", email: null, address: "Schneider Electric, Smyrna TN 37167", zip: "37167",
        serviceInterest: "construction_cleanup", estimatedValue: "5000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-30"),
        notes: "Global energy management company, 900 employees in Smyrna. Large campus with equipment, parking. Ask for facilities or plant manager for exterior washing contract.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-016", leadId: "GDS-L-0016",
        date: new Date("2026-05-26"), source: "direct",
        name: "Maintenance Manager", phone: "", email: null, address: "General Mills, Murfreesboro TN 37129", zip: "37129",
        serviceInterest: "industrial_cleaning", estimatedValue: "6000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-02"),
        notes: "Food manufacturing plant in Murfreesboro. Food plants require frequent exterior sanitation. High standards = higher rates. Contact facilities/maintenance department.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },

      // TIER 2: Property Management (recurring revenue)
      {
        id: "lead-017", leadId: "GDS-L-0017",
        date: new Date("2026-05-26"), source: "direct",
        name: "Property Manager", phone: "615-849-9006", email: null, address: "MMC Properties, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "house_wash", estimatedValue: "2400", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-27"),
        notes: "MMC manages multiple apartment complexes across Rutherford County. Pitch a monthly exterior cleaning contract covering driveways, sidewalks, building facades for all properties. Est. 4+ properties × $600/mo.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-018", leadId: "GDS-L-0018",
        date: new Date("2026-05-26"), source: "direct",
        name: "Operations Director", phone: "615-900-4067", email: null, address: "Real Property Management Rental Solutions, Murfreesboro TN", zip: "37130",
        serviceInterest: "house_wash", estimatedValue: "3000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-28"),
        notes: "RPM covers Rutherford, Davidson, Williamson Counties. Manages properties in Murfreesboro, Smyrna, La Vergne. Quarterly exterior cleaning contract across portfolio = recurring revenue. Call 615-900-4067.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-019", leadId: "GDS-L-0019",
        date: new Date("2026-05-26"), source: "direct",
        name: "Community Manager", phone: "", email: null, address: "Stones River Property Management, Murfreesboro TN", zip: "37130",
        serviceInterest: "house_wash", estimatedValue: "2000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-01"),
        notes: "One of the largest property managers in Middle TN. Pitch seasonal (spring/fall) exterior cleaning packages for their entire portfolio. Contact via website form + follow up by phone.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-020", leadId: "GDS-L-0020",
        date: new Date("2026-05-26"), source: "direct",
        name: "HOA Board Contact", phone: "", email: null, address: "Cedar Management Group HOA, Murfreesboro TN", zip: "37130",
        serviceInterest: "house_wash", estimatedValue: "1500", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-03"),
        notes: "Cedar manages multiple HOAs in Murfreesboro. HOAs pay for common area pressure washing — driveways, sidewalks, entrances, pool decks. Approach with a per-community package price.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },

      // TIER 3: General Contractors (construction cleanup)
      {
        id: "lead-021", leadId: "GDS-L-0021",
        date: new Date("2026-05-26"), source: "direct",
        name: "Project Manager", phone: "", email: null, address: "Dow Smith Company, Smyrna TN 37167", zip: "37167",
        serviceInterest: "construction_cleanup", estimatedValue: "4500", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-29"),
        notes: "Design-build contractor in Smyrna — active commercial projects in Rutherford County. Pitch post-construction cleanup as a turnkey service. Visit website to see active projects, call main line, ask for project manager.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-022", leadId: "GDS-L-0022",
        date: new Date("2026-05-26"), source: "direct",
        name: "Owner / PM", phone: "", email: null, address: "Wright Construction, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "construction_cleanup", estimatedValue: "3500", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-30"),
        notes: "Local GC in Murfreesboro, active commercial + residential. Nearly 50 years in business. They likely don't have a cleanup vendor — pitch: 'We handle the final wash so you hand over a spotless project.' Reference Topre job.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-023", leadId: "GDS-L-0023",
        date: new Date("2026-05-26"), source: "direct",
        name: "Owner", phone: "", email: null, address: "Pinnacle Building Services, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "roof", estimatedValue: "2000", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-02"),
        notes: "150+ commercial roofs in Rutherford County. Pitch post-roof-installation pressure washing — debris, granules, mortar dust. They also need soft wash referrals for maintenance contracts. Could be referral partner too.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },

      // TIER 4: Fleet / Trucking companies
      {
        id: "lead-024", leadId: "GDS-L-0024",
        date: new Date("2026-05-26"), source: "direct",
        name: "Dispatcher / Owner", phone: "615-462-7905", email: null, address: "GFC Cartage LLC, 291 11th Ave, Smyrna TN 37167", zip: "37167",
        serviceInterest: "fleet", estimatedValue: "1200", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-27"),
        notes: "19-year-old trucking company in Smyrna. Call 615-462-7905. Fleet of trucks = monthly wash contract opp. Closest lead with a phone number. Call today.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-025", leadId: "GDS-L-0025",
        date: new Date("2026-05-26"), source: "direct",
        name: "Operations Manager", phone: "", email: null, address: "IKE Transportation, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "fleet", estimatedValue: "1800", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-05-29"),
        notes: "100% employee-owned flatbed carrier in Murfreesboro. Flatbeds haul heavy loads — equipment gets dirty. Monthly fleet wash contract. Find on website iketrans.com.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-026", leadId: "GDS-L-0026",
        date: new Date("2026-05-26"), source: "direct",
        name: "Owner", phone: "", email: null, address: "Somerset Logistics, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "fleet", estimatedValue: "800", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-01"),
        notes: "Family and veteran-owned freight broker in Murfreesboro. Veteran-owned — lead with that connection. Fleet washing for their carrier network. Good referral potential to their clients.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },

      // TIER 5: Auto Dealerships (lot washing + fleet)
      {
        id: "lead-027", leadId: "GDS-L-0027",
        date: new Date("2026-05-26"), source: "direct",
        name: "General Manager", phone: "", email: null, address: "Murfreesboro Hyundai, Murfreesboro TN 37129", zip: "37129",
        serviceInterest: "fleet", estimatedValue: "700", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-02"),
        notes: "Auto dealership — exterior lot washing for inventory vehicles, service drive, showroom parking. Monthly contract. Walk in with a before/after photo, offer a demo wash on their dirtiest car.",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
      {
        id: "lead-028", leadId: "GDS-L-0028",
        date: new Date("2026-05-26"), source: "direct",
        name: "Owner", phone: "", email: null, address: "Speedway Motors, Murfreesboro TN 37130", zip: "37130",
        serviceInterest: "fleet", estimatedValue: "600", status: "new",
        assignedTo: "Blake", quotedAmount: null, followUpDate: new Date("2026-06-03"),
        notes: "20 years same location, A+ BBB. Independent dealer — more flexible than franchise. Lot washing + vehicle detailing upsell. Walk in Tuesday AM (slow for dealers).",
        referredBy: null, adSpend: "0", wonAt: null, lostReason: null,
        createdAt: new Date("2026-05-26"), updatedAt: new Date("2026-05-26"),
      },
    ];
